      ...
      <section class="container">
         ...
         <form:errors path="*" cssClass="alert alert-danger" element="div"/>
            <fieldset>
               ...
               <div class="form-group">
               <label class="control-label col-lg-2 col-lg-2"for="productId">Liczba sztuk w magazynie</label>
                  <div class="col-lg-10">
			...
			<div class="form-group">
   				<label class="control-label col-lg-2" for="productDescription">
      				<spring:message code="addProdcut.form.productDescription.label"/>
   				</label>
   				<div class="col-lg-10">
      				<form:input id="productDescription" path="productDescription" type="file" class="form:input-large" />
   				</div>
			</div>
            <div class="form-group">
